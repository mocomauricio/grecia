"""
Django settings for grecia project.
...
SECRET_KEY = ')ssn$4ng4_g-$pv%(crq(^3r9$4%hlmok)d5s-8!96brx67=ps'
...
WSGI_APPLICATION = 'grecia.wsgi.application'
